"""
Plot cumulative returns for all 10 value-weighted momentum deciles.
...
ff = parse_ff_monthly_section(FF_FILE, "Value Weight Returns -- Monthly")
ff = ff.loc[START:END]
...
ax.set_title(
    "Momentum Deciles — Value-Weighted Returns\n"
